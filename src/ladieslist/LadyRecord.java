...
/*
 * Třída představuje seznam milenek (tzv. záletníkův pomocný notýsek) chceme do
 * ArrayListu seznam všech instancí s údaji o dámách chceme, aby se tento
 * ArrayList na začátku deserializoval ze souboru a na konci opět serializoval
 * do souboru vkládání údajů + ser. a deser. aby byla ošetřena výjimkami každá
 * třída měla gettery, settery a overridelý toString
 *
 * @author DHA
 */
public class LadyRecord {
     ...
     * to samé se dá nastavit příp. u dalších param. */
